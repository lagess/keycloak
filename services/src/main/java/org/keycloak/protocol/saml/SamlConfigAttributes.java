...
public interface SamlConfigAttributes {
    ...
    String SAML_FORCE_AUTHN_ARTIFACT_BINDING = "saml.force.authn.artifact.binding";
    String SAML_FORCE_LOGOUT_ARTIFACT_BINDING = "saml.force.logout.artifact.binding";
