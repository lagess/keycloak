...
@NamedQueries({
        ...
        // CockroachDB currently does not support some types of queries. The current query is a performance optimization (6a289712181192a635174be881a2de4b92a095ee), we go back to the previous version of the query which is not optimized but CockroachDB compatible.
